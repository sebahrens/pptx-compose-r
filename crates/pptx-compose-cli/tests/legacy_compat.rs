mod legacy_compat {
    ...
    #[test]
    fn google_slides_source_family_legacy_roundtrip_preserves_content_types() {
        let temp_dir =
            fresh_temp_dir("google_slides_source_family_legacy_roundtrip_preserves_content_types");
        let fixture = repo_root().join("fixtures/google-slides/source-family.pptx");
        let json_output = temp_dir.join("roundtrip.json");
        let roundtrip = temp_dir.join("roundtrip.pptx");
    ...
    #[test]
    fn libreoffice_source_family_legacy_roundtrip_preserves_content_types() {
        let temp_dir =
            fresh_temp_dir("libreoffice_source_family_legacy_roundtrip_preserves_content_types");
        let fixture = repo_root().join("fixtures/libreoffice/source-family.pptx");
        let json_output = temp_dir.join("roundtrip.json");
        let roundtrip = temp_dir.join("roundtrip.pptx");
    ...
    #[test]
    fn powerpoint_source_family_legacy_roundtrip_preserves_content_types() {
        let temp_dir =
            fresh_temp_dir("powerpoint_source_family_legacy_roundtrip_preserves_content_types");
        let fixture = repo_root().join("fixtures/powerpoint/source-family.pptx");
        let json_output = temp_dir.join("roundtrip.json");
        let roundtrip = temp_dir.join("roundtrip.pptx");
    ...
    #[test]
    fn alternate_content_unknown_part_legacy_roundtrip_preserves_content_types() {
        let temp_dir = fresh_temp_dir(
            "alternate_content_unknown_part_legacy_roundtrip_preserves_content_types",
        );
        let fixture = repo_root().join("fixtures/minimal/alternate-content-unknown-part.pptx");
        let json_output = temp_dir.join("roundtrip.json");
        let roundtrip = temp_dir.join("roundtrip.pptx");
        ...
        assert_eq!(
            zip_entry_bytes(&fixture, "customXml/item1.xml"),
            zip_entry_bytes(&roundtrip, "customXml/item1.xml")
        );
